...
{path:'adminlogin',component:AdminloginComponent},{path:'adminregister',component:AdminregisterComponent},
{path:'',component:IntropageComponent},{path:'flightlist',component:ManageflightComponent},{path:'addflight',component:AddflightComponent},
{path:'updateFlight/:flightId',component:AddflightComponent},{path:'userlist',component:ViewuserComponent},{path:'emplist',component:ViewemployeeComponent},
{path:'employeeregister',component:RegisteremployeeComponent},{path:'employeelogin',component:LoginemployeeComponent},{path:'employeehome',component:EmployeehomeComponent},
{path:'adminprofile',component:AdminprofileComponent},
{path:'employeeprofile',component:EmployeeprofileComponent},{path:'userlogin',component:UserloginComponent},{path:'userregister',component:UserregisterComponent},
{path:'welcomeuser',component:WelcomeuserComponent},{path:'adduser',component:AdduserComponent},{path:'updateuser/:userid',component:AdduserComponent},
{path:'viewflight',component:ViewflightComponent},{path:'userair/addbooking/:id',component:AddbookingComponent},{path:'bookflight',component:AddbookingComponent},
{path:'userprofile',component:UserprofileComponent},{path:'updateemployee/:empid',component:RegisteremployeeComponent},{path:"viewpayments",component:ViewuserpaymentComponent}
,{path:"userair/addpayment",component:AddpaymentComponent},{path:'viewuserbookings',component:ViewuserbookingsComponent},{path:'userair/paymentoptions',component:PaymentoptionsComponent},
{path:'user/mypayments',component:ViewuserpaymentComponent},{path:'viewallpayments',component:ViewallpaymentsComponent},{path:'viewallbookings',component:ViewallbookingsComponent},
